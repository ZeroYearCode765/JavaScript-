...
let message = "Rohit Bhaiya bhut bade badmash hai. \nWo bhut gande insaan hai."; // \n will move statement to next line
console.log(message);
// escape character \ it tells that ignore me and print next character 
...
console.log(hero.indexOf("coder")); // will retun -1
...
//Homework Inspect Console Prototype 
console.log(lasteststring.split(","));
console.log(lasteststring.replace("Coder","BTS"));
console.log(lasteststring.substr(0,5)); // depricated not used now
