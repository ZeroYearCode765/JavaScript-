...
document.getElementById("Alcohol").addEventListener('click',()=>{
    ...
    document.getElementById('root').replaceChildren();// clearing data so that only the filtered out data is shown
    // or  document.getElementById('root').innerHTML = ""; then getrestauarant(result);
